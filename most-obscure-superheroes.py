...
names = spark.read.schema(schema).option("sep", " ").csv("file:///SparkCourse/ml-100k/Marvel-Names.txt")

lines = spark.read.text("file:///SparkCourse/ml-100k/Marvel-Graph.txt")
