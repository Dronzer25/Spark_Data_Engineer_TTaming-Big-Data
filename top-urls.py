'''
how to run ... first run the code using spark submit then 
under ml100K folder there is access_log.txt file copy that file 
put it under th logs directory and it will automatically takes the fiel and run it 


its using windows function and which will run on every 5 min example windows
'''
